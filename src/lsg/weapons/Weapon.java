...
public class Weapon implements Collectible {
    ...
    public String toString() {
        return String.format("WEAPON: %s (min: %d max: %d %s: %d %s: %d)",this.name, this.minDamage, this.maxDamage,STAMINA_STAT_STRING, this.stamCost,DURABILITY_STAT_STRING, this.durability);
    }
